            ...
            for alpha in rep_cfg.alpha_values:
                for beta in rep_cfg.beta_values:
                    ...
                    result = build_gaussian_2d_representation(
                        ...
                        temporal_pool=cfg.preprocess.temporal_pool,
                        temporal_pool_window=cfg.preprocess.temporal_pool_window,
                        temporal_pool_drop_remainder=cfg.preprocess.temporal_pool_drop_remainder,
